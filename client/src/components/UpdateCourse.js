...
const UpdateCourse = ({ context }) => {
    ...
    // console.log("UpdateCourse url: ", history.location.pathname);
    ...
    // useEffect(() => {
    //     context.data.updateCourse(emailAddress, password, id)
    //         .then(res => res.json())
    //         .then(data => setCourse(data))
    // }, [context.data, id, password, emailAddress]);
    ...
    // console.log("Course owner: ", author.id === context.authenticatedUser.id);


    // const titleRef = useRef(course.title);
    ...
    const change = (event) => {
        ...
        console.log("Value from change method: ", value);
        // setTitle({ ...course, [event.target.name]: event.target.value });
        // console.log("Name from change method: ", name);
        switch (name) {
            case "courseTitle":
                setTitle(value);
                break;
        ...
        // if (name === 'courseTitle') {
        //     console.log("courseTitle is equal name");
        //     setTitle(value);
        // }
            ...
            <div className="wrap">
                ...
                <form>
                    <div className="main--flex">
                        <div>
                            <label htmlFor="courseTitle">Course Title</label>
                            <input id="courseTitle" name="courseTitle" type="text" value={course.title} onChange={change} />

                            <label htmlFor="courseAuthor">Course Author</label>
                            <input id="courseAuthor" name="courseAuthor" type="text" value={`${author.firstName} ${author.lastName}`} />
                        ...
                        <div>
                            ...
                            <label htmlFor="materialsNeeded">Materials Needed</label>
                            <textarea id="materialsNeeded" name="materialsNeeded" value={materials} />
                        </div>
                    </div>
                    <button className="button" type="submit">Update Course</button><button className="button button-secondary" onclick="event.preventDefault(); location.href='index.html';">Cancel</button>
                </form>
